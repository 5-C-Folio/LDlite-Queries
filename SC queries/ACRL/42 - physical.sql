select count(distinct it2.id) as "42 Media - physical (title count)"
...
where lt.campus_id in ('7d02e46d-3e60-4eaf-a986-5aa3550e8cb5' --Smith College
	...
	and mtt.name in ('Audio CD', 'Audiocassette', 'CD-ROM', 'DVD/Blu-ray', 'Film', 'Image', 'LP Phonorecord', 'Map', 'Microform', 'Video Game', 'Videocassette')