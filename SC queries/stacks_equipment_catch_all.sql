...
where (lt."name" in ('SC Art Equipment', 'SC Josten Equipment', 'SC Josten Headphone', 'SC Josten Instrument', 'SC Josten Metronome', 'SC Neilson Reserve - Laptop', 'SC', 'SC Neilson Equipment') 
	   or lt2."name" in ('SC Art Equipment', 'SC Josten Equipment', 'SC Josten Headphone', 'SC Josten Instrument', 'SC Josten Metronome', 'SC Neilson Reserve - Laptop', 'SC', 'SC Neilson Equipment'))
		or (lt.campus_id = '7d02e46d-3e60-4eaf-a986-5aa3550e8cb5' and mtt."name" = 'Equipment')