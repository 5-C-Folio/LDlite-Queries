with
  parameters AS (
    SELECT
      '2022-07-01':: VARCHAR AS start_date, --Change this value to the earliest date you want to see (YYYY-MM-DD)
      '2022-08-31':: VARCHAR AS end_date --Change this value to the latest date you want to see (YYYY-MM-DD)
  )
select
